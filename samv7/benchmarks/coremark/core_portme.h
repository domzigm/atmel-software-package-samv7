...
#define ee_printf(...) printf(__VA_ARGS__);printf("\r")
...
*/
  ...
  #define COMPILER_VERSION "Keil " __VERSION__
 ...
 #if defined __CC_ARM /* Keil */
  #define COMPILER_FLAGS "-O3 -OTime"
 #elif defined __ICCARM__ /* IAR */
  #define COMPILER_FLAGS "-O High->Speed"
 #elif defined __GNUC__ /* GCC */
